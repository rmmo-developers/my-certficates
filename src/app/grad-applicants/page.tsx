...
export default function GradApplicantsPage() {
  ...
  // Helper to format date for Step 4 (e.g., 03-MARCH-2026)
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      const result = await saveRegistrant({
        ...
        gradeLevelSection: formData.gradeLevelSection,
        strand: formData.strand,
        schoolYearGraduation: formData.schoolYearGraduation,
        email: formData.email,
        dateStarted: formData.dateStarted,
        dateEnded: formData.dateEnded,
        positionAssigned: formData.positionAssigned,
      });
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FF] pb-12 text-black font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4">
        ...
        {currentStep === 2 && (
          <div className="bg-white rounded-[24px] p-6 md:p-10 border border-slate-100 shadow-sm animate-in fade-in slide-in-from-right-4">
